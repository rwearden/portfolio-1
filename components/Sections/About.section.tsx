    ...
    <div className="my-8 flex flex-row items-center justify-between px-3 font-sen">
      <div>
        ...
        <p className="mt-4 text-white" style={{ width: "80%" }}>
          ...
          <br />
          <br />
          I have jointly delivered software solutions to national and
          international clients including Coop, XPO, DPD, Warbutons and
          Northwest Ambulance Service.
          <br />
          <br />I have been lucky enough to experience the full range of Agile
          roles across the development lifecycle including designing,
